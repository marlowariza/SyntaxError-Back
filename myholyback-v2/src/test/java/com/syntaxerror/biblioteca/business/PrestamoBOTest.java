...
////            List<MaterialesDTO> lista = m.listarPaginadoPorTipoEjemplar(TipoEjemplar.DIGITAL, 10, 1);
////
////        for (MaterialesDTO mat : lista) {
////            System.out.println("ID: " + mat.getIdMaterial() + " - Título: " + mat.getTitulo());
////        }
////
////    }
//
