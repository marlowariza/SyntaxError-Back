...
public class ReportesPorSedeDAOImpl extends DAOImplBase implements ReportesPorSedeDAO {

    private ReportesPorSedeDTO reporte;

    public ReportesPorSedeDAOImpl() {
    ...
    private void incluirParametrosReporteSede(Object objetoParametros) {
        ...
        try {
            ...
            Logger.getLogger(ReportesPorSedeDAOImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
