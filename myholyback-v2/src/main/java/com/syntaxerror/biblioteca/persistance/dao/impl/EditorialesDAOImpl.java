...
public class EditorialesDAOImpl extends DAOImplBase implements EditorialesDAO {

    private EditorialesDTO editorial;

    public EditorialesDAOImpl() {
    ...
    protected void instanciarObjetoDelResultSet() throws SQLException {
        this.editorial = new EditorialesDTO();
    ...
    public ArrayList<EditorialesDTO> listarTodos() {
        return (ArrayList<EditorialesDTO>) super.listarTodos();
    }
