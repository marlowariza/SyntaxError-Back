...
public class ReportesGeneralesDAOImpl extends DAOImplBase implements ReportesGeneralesDAO {

    private ReportesGeneralesDTO reporte;

    public ReportesGeneralesDAOImpl() {
    ...
    private void incluirParametrosReporteGeneral(Object objetoParametros) {
        ...
        try {
            ...
            Logger.getLogger(ReportesGeneralesDAOImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
