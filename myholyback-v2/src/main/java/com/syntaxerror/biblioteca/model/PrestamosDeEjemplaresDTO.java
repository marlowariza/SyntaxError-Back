 ...
 * @author MARLOW
 */
public class PrestamosDeEjemplaresDTO {
    ...
    // Constructores
    public PrestamosDeEjemplaresDTO() {
    ...
    public PrestamosDeEjemplaresDTO(Integer idPrestamo, Integer idEjemplar, EstadoPrestamoEjemplar estado,
