...
-- Schema myholylib
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `myholylib` DEFAULT CHARACTER SET utf8mb3 ;
USE `myholylib` ;
...
CREATE TABLE IF NOT EXISTS `myholylib`.`BIB_CREADORES` (
  ...
  `SEUDONIMO` VARCHAR(50) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `myholylib`.`BIB_MATERIALES` (
  ...
  `EDICION` VARCHAR(45) NULL DEFAULT NULL,
  `ANHIO_PUBLICACION` INT NULL DEFAULT NULL,
  `PORTADA` VARCHAR(255) NULL DEFAULT NULL,
  `VIGENTE` TINYINT NOT NULL,
  `NIVEL_IDNIVEL` INT NULL DEFAULT NULL,
  `EDITORIAL_IDEDITORIAL` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `myholylib`.`BIB_EJEMPLARES` (
  ...
  `FORMATO_DIGITAL` ENUM('MP3', 'PDF', 'CBR', 'PPT') NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `myholylib`.`BIB_TEMAS` (
  ...
  `ID_TEMA_PADRE` INT NULL DEFAULT NULL,
  PRIMARY KEY (`ID_TEMA`),
...
CREATE TABLE IF NOT EXISTS `myholylib`.`BIB_PERSONAS` (
  ...
  `TURNO` ENUM('MANHANA', 'TARDE', 'NOCHE') NULL DEFAULT NULL,
  `FECHA_CONTRATO_INI` DATE NULL DEFAULT NULL,
  `FECHA_CONTRATO_FIN` DATE NULL DEFAULT NULL,
  `DEUDA_ACUMULADA` DOUBLE NULL DEFAULT '0',
  `FECHA_SANCION_FIN` DATE NULL DEFAULT NULL,
  `VIGENTE` TINYINT NULL DEFAULT NULL,
  `NIVEL_IDNIVEL` INT NULL DEFAULT NULL,
  `SEDE_IDSEDE` INT NOT NULL,
